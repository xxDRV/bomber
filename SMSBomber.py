...
if E == str(1):
    ...
    if p == str(1):
        kol2 =  input("\n Введите время не больше 20 секунд !>> ")
...
R = 0
message7 = "\033[94m \n Для выхода ткните Ctrl + C ! \033[0m"
message5 = "\033[94m \n Для выхода ткните Ctrl + C или на крестик \033[0m"
if oso == "posix":
...
print(Fore.RED)
_phone = input('\n \033[31mНомер без "+", "8"  прочего говна >\033[0m\033[94m')
...
kol = input("\n \033[31mВремя атаки в секундах(Ставить не меньше 10 , 0 - бесконечно)>\033[0m\033[94m ")
if kol == str(0):
